...
FROM docker.io/hexpm/elixir:1.16.2-erlang-26.2.3-alpine-3.19.1 AS elixir-builder
...
ARG SHAKA_PACKAGER_VERSION=3.0.3
...
RUN curl -L \
  ...
  https://github.com/google/shaka-packager/releases/download/v$SHAKA_PACKAGER_VERSION/packager-linux-x64
