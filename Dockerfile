...
FROM docker.io/hexpm/elixir:1.13.1-erlang-24.2-alpine-3.14.2 AS elixir-builder
...
#   application
# -----------------------------------
FROM docker.io/alpine:3.14.2 as elixir-runner
...
# - job: assets
# -----------------------------------
FROM docker.io/node:16.13.2-alpine3.14 AS assets
