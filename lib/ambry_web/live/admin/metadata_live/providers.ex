defmodule AmbryWeb.Admin.MetadataLive.Providers do
            ...
            >
              ...
              >
                ...
                <div :for={field <- entry.module.config_fields()}>
                  ...
                  />
                  <p :if={field.help} class="mt-1 text-xs text-zinc-400">
                    {field.help}
                  </p>
                </div>
  ...
  defp notice_class(:info), do: "text-zinc-400"
  defp notice_class(:warning), do: "text-amber-500"
  defp notice_class(:error), do: "text-red-500"
