...
#             <.book_header book={@media.book} /> Narrated by
#             <.all_people_links people={@media.narrators} full_cast={@media.full_cast} />
...
#             />
#           </div>
#           <%!-- <div class="flex items-center gap-2 rounded-sm rounded-t-none border border-t-0 border-zinc-200 bg-zinc-50 px-3 py-3 text-zinc-800 shadow-md dark:divide-zinc-800 dark:border-zinc-800 dark:bg-zinc-900 dark:text-zinc-200">
...
#               <% end %>
#             </div>
#             <p class="grow text-zinc-600 dark:text-zinc-400">
...
#             <div
#               class="bg-brand h-1 dark:bg-brand-dark"
#               style={"width: #{progress_percent(@player, @player.player_state)}%;"}
#             />
#           </div> --%>
...
#               <div class="cursor-pointer fill-current" phx-click={media_click_action(@player, @media)}>
#                 <%= if playing?(@player, @media) do %>
#                   <FA.icon name="pause" class="h-10 w-10" />
#                 <% else %>
#                   <FA.icon name="play" class="h-10 w-10 pl-1" />
#                 <% end %>
#               </div>
#               <p class="grow text-zinc-600 dark:text-zinc-400">
#                 <%= duration_display(@media.duration) %>
#               </p>
#             </div>
#             <div :if={@media.notes || @media.supplemental_files != []} class="space-y-2 py-3">
